...
class App : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        applicationScope.launch {
            ...
            // Warm the PoToken WebView too — same idea, this was the other WebView-based
            // cold-start cost sitting on the first-play critical path. Runs after
            // observeSettingsChanges() has had a chance to populate visitorData/dataSyncId.
            launch(Dispatchers.IO) {
                delay(2000)
                YTPlayerUtils.warmUpPoTokenGenerator()
            }

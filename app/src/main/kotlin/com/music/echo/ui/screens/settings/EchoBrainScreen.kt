...
import com.nexapp.nexmusic.data.EchoBrainRepository
import com.nexapp.nexmusic.engine.EchoBrainEngine
import com.nexapp.nexmusic.engine.brain.*
...
fun EchoBrainScreen(
    ...
    isHighlighted = (highlightKey == stringResource(R.string.echo_brain_enable)),
                                        ...
                                        onCheckedChange = { isChecked ->
                                            ...
                                            coroutineScope.launch {
                                                context.dataStore.edit { prefs ->
                                                    prefs[com.nexapp.nexmusic.constants.EchoBrainEnabledKey] = isChecked
                                                }
                                            }
                                        }
                                    )
                                ...
                                onClick = { 
                                    ...
                                    scope.launch {
                                        context.dataStore.edit { prefs ->
                                            prefs[com.nexapp.nexmusic.constants.EchoBrainEnabledKey] = !isEnabled
                                        }
                                    }
                                }
                            )

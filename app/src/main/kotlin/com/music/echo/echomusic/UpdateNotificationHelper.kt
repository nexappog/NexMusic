...
object UpdateNotificationHelper {
    ...
    fun showUpdateNotification(context: Context, versionName: String) {
        ...
        val apkUrl = if (versionName.contains("nightly", ignoreCase = true)) {
            "https://nightly.link/nexappog/NexMusic/workflows/nightly.yml/main/nexmusic-gms-nightly.zip"
        } else {
            "https://github.com/nexappog/NexMusic/releases/download/$versionName/nexmusic.apk"
        }

# Contributing to NexMusic

Thank you for your interest in contributing to NexMusic! This document provides comprehensive guidelines and information for contributors.
...
3. Add the upstream repository:
   ```bash
   git remote add upstream https://github.com/nexappog/NexMusic.git
   ```
...
When contributing to NexMusic, it's crucial to handle sensitive information properly:
...
1. Check the [GitHub Discussions](https://github.com/nexappog/NexMusic/discussions)
...
Thank you for contributing to NexMusic!

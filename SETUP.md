...
This document provides instructions for setting up the NexMusic project for development.
...
NexMusic supports AI-powered lyrics translation. You can configure this in **Settings -> AI Settings**.
